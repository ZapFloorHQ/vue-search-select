...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BasicSelect = __webpack_require__(46);
	...
	var _ModelSelect = __webpack_require__(47);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _baseMixin = __webpack_require__(55);
	  ...
	  enterItem: function enterItem(self) {
	    ...
	    if (currentItem) {
	      ...
	      if (self.allowAddItem) {
	        var newObj = { value: self.searchText, text: self.searchText };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    selectItem: function selectItem(option) {
	      var newOption = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	      ...
	      selectedOptions = _lodash2.default.unionWith(this.selectedOptions, [option], _lodash2.default.isEqual);
	  ...
	  return _c('div', {
	    ...
	    on: {
	      ...
	      "keydown": [function($event) {
	        ...
	        if (!('button' in $event) && _vm._k($event.keyCode, "anyKeyCode", undefined, $event.key)) { return null; }
	        _vm.openOptions($event)
	      }],
	      "keyup": [function($event) {
	        if (!('button' in $event) && _vm._k($event.keyCode, "enter", 13, $event.key)) { return null; }
